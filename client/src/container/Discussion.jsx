                ...
                <div className="text-center py-16 bg-white rounded-xl border-2 border-dashed border-gray-200 shadow-sm">
                  <div className="max-w-md mx-auto">
                    ...
                    <p className="text-gray-500 mb-6 leading-relaxed">
                      {searchQuery
                        ? "No discussions match your search criteria. Try adjusting your search terms or scope."
                        : "Be the first to start a conversation in this community. Share your thoughts, ask questions, or spark a discussion!"}
                    </p>
                      ...
                      <>
                        {user ? (
                          <button
                            ...
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-DGXgreen to-DGXblue text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 font-semibold"
                          >
                            <svg
                              className="w-5 h-5"
                              fill="none"
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 bg-gray-300 text-gray-600 px-6 py-3 rounded-lg cursor-not-allowed font-semibold"
                            disabled
                          >
                            <svg
                              className="w-5 h-5"
                    ...
                    {searchQuery && (
                      <button
                        ...
                        className="inline-flex items-center gap-2 text-DGXgreen hover:text-DGXblue font-semibold transition-colors duration-200 px-4 py-2 border border-gray-300 rounded-lg hover:border-DGXgreen"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
