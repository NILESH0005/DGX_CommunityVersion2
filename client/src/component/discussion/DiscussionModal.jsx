          ...
          <div className="flex justify-between items-start p-4 sm:p-6 border-b border-gray-200">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <ProfileImage
                ...
                style={{
                  backgroundImage: `url(${
                    user?.ProfilePicture || images.defaultProfile
                  })`,
                }}
                alt="User"
              />
          ...
          <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
            ...
            >
              ...
              <div className="p-3 sm:p-4 border-b border-gray-200">
                <div className="flex space-x-2">
                  {/* Use ProfileImage component for current user's profile image in comment input */}
                  <ProfileImage
                    userId={user?.UserID}
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-gray-300 bg-cover bg-center"
                    style={{
                      backgroundImage: `url(${
                        user?.ProfilePicture || images.defaultProfile
                      })`,
